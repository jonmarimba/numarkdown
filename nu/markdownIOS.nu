...
(load "beautify") ; To get the handy `strip` extension to NSString
...
(class NSString
     ...
     (- (id) replaceOccurrencesOfString:(id)old withString:(id)new is
...
(class NuMarkdown is NSObject
     (+ (id) convert:(id) text is (Markdown text)))